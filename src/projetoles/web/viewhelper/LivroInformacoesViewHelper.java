...
public class LivroInformacoesViewHelper implements iViewHelper {
		...
		if(!operacao.equals("VISUALIZAR")){
			...
			if(autor != null && !autor.trim().equals("")){
				...
				livro.setPeso(Double.parseDouble(peso));
                          ...
                          if(precoCompra != null && !precoCompra.trim().equals("")){
				livro.setPrecoCompra(Double.parseDouble(precoCompra));
			}                          
			...
			Resultado resultado = (Resultado) session.getAttribute("resultadoLivro");
	...
	public void setView(Resultado resultado, HttpServletRequest request, 
		...
		if(!operacao.equals("VISUALIZAR")){
                    if(request.getRequestURI().equals("/Livraria/Loja/LojaOperacao")){
                       d = request.getRequestDispatcher("Loja.jsp");
                    }
